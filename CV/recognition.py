...
fingerprint_img = cv2.imread("./fingerprint1.jpg")

fingerprint_img = cv2.resize(fingerprint_img, None, fx=1, fy=1)
...
keypoints_1, descriptors_1 = sift.detectAndCompute(fingerprint_img, None)
...
result = cv2.drawMatchesKnn(fingerprint_img, keypoints_1, fingerprint_db_img, 
